...
@section('title', 'Festivalan - Event Ticketing Platform') {{-- Menetapkan judul khusus untuk halaman ini --}}
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
            ...
            <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
                <button class="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300" id="user-menu-button" type="button">
                    ...
                    <img alt="user photo" class="w-8 h-8 rounded-full" id="dropdown-avatar" src="{{ asset('36') }}"/>
                </button>
                <div class="hidden absolute top-12 mt-2 w-48 bg-white rounded-lg shadow-lg z-50 text-[#1a365d]" id="user-dropdown">
                    ...
                    <ul class="py-1" id="user-dropdown">
                        ...
                        <li><a class="block px-4 py-2 text-sm text-[#e53e3e] hover:bg-gray-100" href="{{ route('auth')}}" id="logout">Keluar</a></li>
                    </ul>
                </div>
            </div>
...
<section class="overflow-hidden whitespace-nowrap bg-white py-6" id="event-gallery">
    ...
    <div class="inline-block animate-marquee">
        <img class="inline-block mx-6 w-60 h-[400px] object-cover rounded-2xl shadow-lg" src="{{ asset('1257w-Ghk8lx6yUCQ.webp') }}">
        <img class="inline-block mx-6 w-60 h-[400px] object-cover rounded-2xl shadow-lg" src="{{ asset('4535650015b7608dce2f8e36a42785eb.jpg') }}"/>
        <img class="inline-block mx-6 w-60 h-[400px] object-cover rounded-2xl shadow-lg" src="{{ asset('4c290251b6a184c00609d07e8f40fc9b.jpg') }}"/>
        <img class="inline-block mx-6 w-60 h-[400px] object-cover rounded-2xl shadow-lg" src="{{ asset('1131w-96LTeHAy_0c.webp') }}"/>
        <img class="inline-block mx-6 w-60 h-[400px] object-cover rounded-2xl shadow-lg" src="{{ asset('1131w-o5eGmJ05izs.webp') }}"/>
        <img class="inline-block mx-6 w-60 h-[400px] object-cover rounded-2xl shadow-lg" src="{{ asset('event-night-flyer-template-b354cd8cd9d0513d7b0dc7f8df2202d2_screen.jpg') }}"/>
        <img class="inline-block mx-6 w-60 h-[400px] object-cover rounded-2xl shadow-lg" src="{{ asset('6cdba24179ddf294aa2d59613a873ad6.jpg') }}"/>
    </div>
</section>
    ...
    <div class="container mx-auto">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <img alt="Event 1" class="w-full" src="{{ asset('pdhday.jpg') }}"/>
                <div class="p-4">
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <img alt="Event 2" class="w-full" src="{{ asset('bukber.jpg') }}"/>
                <div class="p-4">
            ...
            <div class="bg-white shadow-lg rounded-lg overflow-hidden">
                <img alt="Event 3" class="w-full" src="{{ asset('peerteaching.jpg') }}"/>
                <div class="p-4">
...
{{-- Modals from original Beranda.blade.php --}}
